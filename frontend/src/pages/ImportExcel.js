...
const KINDS = {
  students: {
    ...
    required: ['admission_no', 'name', 'department_code', 'class_name'],
    optional: ['guardian_name', 'guardian_mobile', 'address', 'medium'],
    sample: [
      ['BC-EP-101', 'Aarav Sharma', 'EP', 'Class 3', 'Rajesh Sharma', '9876500001', 'Butibori', 'English'],
